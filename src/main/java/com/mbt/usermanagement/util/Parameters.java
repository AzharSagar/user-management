...
public class Parameters {
	...
	public final static String KEY_SECURITY_OPEN_API_PATTERN1 = "${api.pattern.open1}";
	public static final String KEY_SECURITY_SECURE_API_PATTERN = "${api.pattern.private}";
